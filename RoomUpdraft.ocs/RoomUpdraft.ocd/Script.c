...
public func GetRoomSection() { return "Updraft"; }
...
public func GetRoomID() { return "Up"; }

// The difficulty of this room, ranges from 0 to 999.
public func GetRoomDifficulty() { return 249; }
...
{
	SetPlayerZoomByViewRange(plr, 300, nil, PLRZOOM_LimitMin);

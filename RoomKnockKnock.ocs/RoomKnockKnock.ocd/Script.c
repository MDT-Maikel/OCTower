...
public func GetRoomAuthor() { return "Sven2 & Wipfhunter"; }

// The map section that needs to be loaded for this room, usually equal to the name of the room.
public func GetRoomSection() { return "KnockKnock"; }
...
public func GetRoomID() { return "SK"; }

// The difficulty of this room, ranges from 0 to 999.
public func GetRoomDifficulty() { return 67; }
...
public func GetRoomHints() { return ["$RoomHint1$", "$RoomHint2$"]; }

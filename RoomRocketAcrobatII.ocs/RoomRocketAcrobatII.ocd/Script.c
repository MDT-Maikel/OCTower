...
public func GetRoomSection() { return "RocketAcrobatII"; }
...
public func GetRoomID() { return "Rt"; }

// The difficulty of this room, ranges from 0 to 999.
public func GetRoomDifficulty() { return 145; }
...
{
	RoomEffectAddFallingClonks(60, 620, -25, 9);
	return;
}

...
func InitializeObjects()
{
	...
	var Metal001 = CreateObject(Metal, 320, 244);
	Metal001->SetR(-9);
	Metal001->SetRDir(-2);
	Metal001->SetPosition(320, 244);
	...
	var Dynamite002 = CreateObject(Dynamite, 324, 209);
	Dynamite002->SetR(-178);
	Dynamite002->SetPosition(324, 209);
	...
	var Dynamite009 = CreateObject(Dynamite, 331, 209);
	Dynamite009->SetR(-178);
	Dynamite009->SetPosition(331, 209);
	...
	var PowderKeg004 = CreateObject(PowderKeg, 613, 63);
	PowderKeg004->SetR(-82);
	PowderKeg004->SetPosition(613, 63);
	...
	var Shield001 = CreateObject(Shield, 595, 79);
	Shield001->SetPosition(595, 79);
	var Shield002 = CreateObject(Shield, 587, 61);
	Shield002->SetR(46);
	Shield002->SetPosition(587, 61);

	var Helmet001 = CreateObject(Helmet, 607, 59);
	Helmet001->SetPosition(607, 59);
	var Helmet002 = CreateObject(Helmet, 601, 42);
	Helmet002->SetR(55);
	Helmet002->SetPosition(601, 42);

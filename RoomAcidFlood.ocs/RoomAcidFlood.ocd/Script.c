...
public func GetRoomSection() { return "AcidFlood"; }
...
public func GetRoomID() { return "Ac"; }

// The difficulty of this room, ranges from 0 to 999.
public func GetRoomDifficulty() { return 25; }
...
{
	// Adjust the sky color.
	SetSkyAdjust(RGBa(185, 255, 185, 191), RGB(40, 240, 0));
	return;
}

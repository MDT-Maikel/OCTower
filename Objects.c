...
{
	var Grass001 = CreateObjectAbove(Grass, 118, 359);
	...
	var Grass006 = CreateObjectAbove(Grass, 158, 359);
	var Grass007 = CreateObjectAbove(Grass, 173, 358);
	var Grass008 = CreateObjectAbove(Grass, 179, 358);
	...
	var Grass016 = CreateObjectAbove(Grass, 250, 357);
	var Grass017 = CreateObjectAbove(Grass, 258, 356);
	var Grass018 = CreateObjectAbove(Grass, 262, 351);
	var Grass019 = CreateObjectAbove(Grass, 238, 357);
	var Grass020 = CreateObject(Grass, 269, 346);
	Grass020->SetPosition(269, 346);
	...
	Tree_Coniferous4001->SetSeedAmount(0);
	Tree_Coniferous4001->SetSeedChance(0);

	var Tree_Deciduous002 = CreateObjectAbove(Tree_Deciduous, 182, 363);
	Tree_Deciduous002->SetCon(103);
	Tree_Deciduous002->SetSeedAmount(0);
	Tree_Deciduous002->SetSeedChance(0);

	var Tree_Coniferous2002 = CreateObjectAbove(Tree_Coniferous2, 269, 349);
	Tree_Coniferous2002->SetCon(104);
	Tree_Coniferous2002->SetSeedAmount(0);
	Tree_Coniferous2002->SetSeedChance(0);

	var Tree_Deciduous003 = CreateObjectAbove(Tree_Deciduous, 288, 338);
	Tree_Deciduous003->SetCon(102);
	Tree_Deciduous003->SetSeedAmount(0);
	Tree_Deciduous003->SetSeedChance(0);

	var Tree_Coniferous4002 = CreateObjectAbove(Tree_Coniferous4, 168, 361);
	Tree_Coniferous4002->SetSeedAmount(0);
	Tree_Coniferous4002->SetSeedChance(0);
	var Tree_Coniferous4003 = CreateObjectAbove(Tree_Coniferous4, 175, 362);
	Tree_Coniferous4003->SetCon(95);
	Tree_Coniferous4003->SetSeedAmount(0);
	Tree_Coniferous4003->SetSeedChance(0);

	var Tree_Deciduous004 = CreateObjectAbove(Tree_Deciduous, 219, 363);
	Tree_Deciduous004->SetCon(102);
	Tree_Deciduous004->SetSeedAmount(0);
	Tree_Deciduous004->SetSeedChance(0);

	var Wheat003 = CreateObject(Wheat, 212, 375);
	Wheat003->SetCon(9);
	...
	var Rock002 = CreateObject(Rock, 360, 374);
	...
	var Ore002 = CreateObject(Ore, 85, 461);
	Ore002->SetPosition(85, 461);
	var Ore003 = CreateObject(Ore, 229, 443);
	Ore003->SetPosition(229, 443);
	var Ore004 = CreateObject(Ore, 258, 413);
	Ore004->SetPosition(258, 413);
	...
	Firestone004->SetPosition(452, 437);
	var Firestone005 = CreateObject(Firestone, 189, 400);
	Firestone005->SetPosition(189, 400);
	var Firestone006 = CreateObject(Firestone, 135, 430);
	Firestone006->SetPosition(135, 430);
	var Firestone007 = CreateObject(Firestone, 272, 390);
	Firestone007->SetPosition(272, 390);
	return true;
}

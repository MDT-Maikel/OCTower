...
public func GetRoomSection() { return "RocketAcrobat"; }
...
public func GetRoomID() { return "RA"; }

// The difficulty of this room, ranges from 0 to 999.
public func GetRoomDifficulty() { return 85; }
...
{
	RoomEffectAddFallingClonks(100, 340, -25, 9);
	return;
}

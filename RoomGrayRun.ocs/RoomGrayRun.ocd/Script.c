...
public func GetRoomAuthor() { return "Luchs, Maikel & Sven2"; }

// The map section that needs to be loaded for this room, usually equal to the name of the room.
public func GetRoomSection() { return "GrayRun"; }
...
public func GetRoomID() { return "GR"; }

// The difficulty of this room, ranges from 0 to 999.
public func GetRoomDifficulty() { return 12; }

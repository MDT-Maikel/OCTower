...
public func GetRoomAuthor() { return "K-Pone, Maikel"; }

// The map section that needs to be loaded for this room, usually equal to the name of the room.
public func GetRoomSection() { return "ScorchingLeap"; }
...
public func GetRoomID() { return "SP"; }

// The difficulty of this room, ranges from 0 to 999.
public func GetRoomDifficulty() { return 122; }
...
public func GetValueOverloads() { return [{type = Snow, value = 20}, {type = Ice, value = 16}]; }

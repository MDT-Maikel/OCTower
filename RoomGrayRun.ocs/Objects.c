...
func InitializeObjects()
{
	...
	var RoomDoor005 = CreateObjectAbove(RoomDoor, 111, 239);
	...
	var Diamond002;
	var Diamond003;
	CreateObject(AncientTablet, 281, 352);

	CreateObject(DynamiteBox, 223, 343);
	var Bread001 = CreateObjectAbove(Bread, 352, 454);
	Bread001->Unstick(7);

	var Trunk001 = CreateObject(Trunk, 212, 310);
	Trunk001->SetCon(145);
	Trunk001->SetR(-141);
	Trunk001.Plane = 500;
